/**
* Copyright (c) 2018, SOW (https://www.safeonline.world/, https://www.facebook.com/safeonlineworld). (https://github.com/RKTUXYN) All rights reserved.
* @author {SOW}
...
Sow.Run( function () {
    ...
    this.registerNamespace(/**[settings]*/'Sow.Net.Web.Auth.Login', function () {
                                            ...
                                            if ( data.ret_val === -550 ) {
                                                {
                                                    ...
                                                    let amsg = '<ul style="list-style:none;">', mc = 0;
                                                    for ( let key of arr ) {
                                                        let karr = _MSG[String( key )];
                                                        ...
                                                        amsg += String.format( "<li>{0}</li>", karr[1] );
                                                        mc++;
                                                    }
                                                    if ( mc > 0 ) {
                                                        amsg += "</ul>";
                                                        $gmsg.html( amsg );
                                                        $gmsgP.css( 'display', "" ); amsg = $gmsg = $gmsgP = undefined;
                                                    }
                                                }
        ...
        return /**[modules]*/[{
            ...
            //[/Extend VIEW]
            101: [function ( require, _module, exports ) {
                return _module.aggregate( function () {
                    return {
                        onLoad: function ( a ) {
                            console.log( a );
                        },
        ...
        return /**[modules]*/[{
            //[Extend VIEW]
            100: [function ( require, _module, exports ) {
